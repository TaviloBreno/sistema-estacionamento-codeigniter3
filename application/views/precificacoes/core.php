...
<div class="main-content">
    <div class="container-fluid">
                ...
                <div class="col-lg-4">
                    <nav class="breadcrumb-container" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">
                                <a data-toggle="tooltip" data-placement="top" title="Editar <?php echo str_replace("a", "á", ucfirst($this->router->fetch_class())); ?>" href="<?php echo base_url('precificacaos'); ?>" href="<?php echo base_url($this->router->fetch_class()); ?>">Listagem de <?php echo str_replace("a", "á", ucfirst($this->router->fetch_class())); ?></a>
                            </li>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header"><i class="ik ik-calendar ik-2x"></i>&nbsp;<b>Última atualização:</b>&nbsp; <?php echo isset($precificacao) ? formata_data_banco_com_hora($precificacao->precificacao_data_alteracao) : ''; ?></div>
                    <div class="card-body">
                        <form class="forms-sample" name="form_core" method="POST">
                            <div class="form-group row">
                                <div class="col-md-4 mb-20">
                                    ...
                                    <?php echo form_error('precificacao_categoria', '<small class="text-danger">', '</small>'); ?>
                                </div>
                                <div class="col-md-2 mb-20">
                                    ...
                                    <?php echo form_error('precificacao_valor_hora', '<small class="text-danger">', '</small>'); ?>
                                </div>
                                <div class="col-md-2 mb-20">
                                    ...
                                    <?php echo form_error('precificacao_valor_mensalidade', '<small class="text-danger">', '</small>'); ?>
                                </div>
                                <div class="col-md-2 mb-20">
                                    ...
                                    <?php echo form_error('precificacao_numero_vagas', '<small class="text-danger">', '</small>'); ?>
                                </div>
                                <div class="col-md-2 mb-20">
                                    <label>Ativa</label>
                                    <select name="precificacao_ativa" class="form-control">
