                            ...
                            <tbody>
                                <?php foreach ($usuarios as $usuario) : ?>
                                    <tr>
                                        ...
                                        <td><?php echo ($this->ion_auth->is_admin($usuario->id) ? 'Administrador' : 'Atendente'); ?></td>
                                        <td><?php echo ($usuario->active == 1) ? '<span class="badge badge-pill badge-success mb-1"><i class="fas fa-lock-open"></i>&nbsp;Sim</span>' : '<span class="badge badge-pill badge-danger mb-1"><i class="fas fa-lock"></i>&nbsp;Não</span>'; ?></td>
                                        <td class="text-right">
                                            <a data-toggle="tooltip" data-placement="top" title="Editar <?php echo str_replace("a", "á", ucfirst($this->router->fetch_class())); ?>" href="<?php echo base_url($this->router->fetch_class() . '/core/' . $usuario->id); ?>" class="btn btn-icon btn-primary"><i class="ik ik-edit-2"></i></a>
                                            <button type="button" class="btn btn-icon btn-danger" data-toggle="modal" data-target="#user-<?php echo $usuario->id; ?>"><i class="ik ik-trash"></i></button>
                                        </td>
                                    </tr>
                                        ...
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <a data-toggle="tooltip" data-placement="top" title="Editar <?php echo str_replace("a", "á", ucfirst($this->router->fetch_class())); ?>" href="<?php echo base_url($this->router->fetch_class() . '/del/' . $usuario->id); ?>" class="btn btn-danger">Sim, excluir</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
